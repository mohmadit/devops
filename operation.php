    ...
    <nav class="col-md-2 d-none d-md-block sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link" href="#">Displaying the time plan</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Displaying tasks</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Deploying applications</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Documenting processes</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Running the application</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Infrastructure management</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Backup management</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Achieving integration</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Technical support</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Running versions</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Sending reports</a>
          </li>
        </ul>
      </div>
    </nav>
