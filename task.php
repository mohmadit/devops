    ...
    <main role="main" class="col-md-10 main-content">
      ...
      <div class="container">
        ...
        <form action="addtask.php" method="post">
          ...
          <div class="form-group">
            <label for="responsibleTeam">Responsible Team</label>
            <input type="text" class="form-control" id="responsibleTeam" name="responsibleTeam">
          </div>
          <div class="form-group">
            <label for="responsibleUser">Responsible User</label>
            <input type="text" class="form-control" id="responsibleUser" name="responsibleUser">
          </div>
          ...
          <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>";
                    echo "<button class='btn btn-primary edit-btn' data-toggle='modal' data-target='#editTaskModal' data-tasknumber='".$row["taskNumber"]."' data-taskname='".$row["taskName"]."' data-tasktype='".$row["taskType"]."' data-startdate='".$row["startDate"]."' data-enddate='".$row["endDate"]."' data-responsibleteam='".$row["responsibleTeam"]."' data-responsibleuser='".$row["responsibleUser"]."'>Update</button>";
      ...
      <div class="modal-body">
        <form action="edittask.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="editTaskType" name="editTaskType">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="editResponsibleTeam">Responsible Team</label>
            <input type="text" class="form-control" id="editResponsibleTeam" name="editResponsibleTeam">
          </div>
          <div class="form-group">
            <label for="editResponsibleUser">Responsible User</label>
            <input type="text" class="form-control" id="editResponsibleUser" name="editResponsibleUser">
          </div>
...
<script>
  $(document).ready(function() {
    $('.edit-btn').click(function() {
      ...
      var responsibleTeam = $(this).data('responsibleteam');
      var responsibleUser = $(this).data('responsibleuser');
      ...
      $('#editResponsibleTeam').val(responsibleTeam);
      $('#editResponsibleUser').val(responsibleUser);
    });
