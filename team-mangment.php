    ...
    <nav class="col-md-2 d-none d-md-block sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link" href="#" id="teamMemberLink">Team Member Management</a>
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    var teamMemberLink = document.getElementById('teamMemberLink');
    var teamMemberMenu = document.getElementById('teamMemberMenu');

    teamMemberLink.addEventListener('click', function() {
      teamMemberMenu.style.display = (teamMemberMenu.style.display === 'none') ? 'block' : 'none';
    });
  });
</script>
</body>
